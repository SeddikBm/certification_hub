...
public class DashboardService {
    ...
    public DashboardStatsResponse getStats() {
        return DashboardStatsResponse.builder()
                .totalCertifications(certificationRepository.countByDeletedAtIsNull())
                .totalTrainings(trainingRepository.countByDeletedAtIsNull())
                .totalUsers(userRepository.countByDeletedAtIsNull())
                .totalSquads(squadRepository.countByDeletedAtIsNull())
